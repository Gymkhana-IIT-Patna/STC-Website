...
$result = $db->query("SELECT * FROM eV2InzIbsBy2ARNhON4vc1ce5yM9142rOFQ0ZtQBH5iS1VnflbNxe8dgPAzpDuKk");
echo
'
	<table>
		<tr><th>Name</th><th>Roll Number</th><th>College Email ID</th></tr>';
while ($row = $result->fetchArray(SQLITE3_ASSOC)) {
$form_1 = $row["form_1"];$form_2 = $row["form_2"];$form_3 = $row["form_3"];echo "<tr><td>$form_1</td><td>$form_2</td><td>$form_3</td></tr>";}
