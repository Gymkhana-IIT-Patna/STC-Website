...
$result = $db->query("SELECT * FROM OqCMrAYI6Qw1RLltAOoIVloO5RWc7tH2eKiiTWR8YzF67hCdB8XZzaOXYj5leabi");
echo
'
	<table>
		<tr><th>Club name</th><th>Linkedin account link</th><th>Insta account link</th><th>Any other links (specify)</th><th>Coordinator names</th><th>Subcoordinator names</th></tr>';
while ($row = $result->fetchArray(SQLITE3_ASSOC)) {
$form_1 = $row["form_1"];$form_2 = $row["form_2"];$form_3 = $row["form_3"];$form_4 = $row["form_4"];$form_5 = $row["form_5"];$form_6 = $row["form_6"];echo "<tr><td>$form_1</td><td>$form_2</td><td>$form_3</td><td>$form_4</td><td>$form_5</td><td>$form_6</td></tr>";}
