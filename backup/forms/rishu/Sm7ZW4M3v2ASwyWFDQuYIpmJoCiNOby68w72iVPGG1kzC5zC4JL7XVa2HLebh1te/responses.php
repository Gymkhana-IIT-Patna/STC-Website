...
<body>
	<h1>Sm7ZW4M3v2ASwyWFDQuYIpmJoCiNOby68w72iVPGG1kzC5zC4JL7XVa2HLebh1te</h1>';
$result = $db->query("SELECT * FROM Sm7ZW4M3v2ASwyWFDQuYIpmJoCiNOby68w72iVPGG1kzC5zC4JL7XVa2HLebh1te");
echo
'
	<table>
		<tr><th>q3</th></tr>';
while ($row = $result->fetchArray(SQLITE3_ASSOC)) {
$form_1 = $row["form_1"];echo "<tr><td>$form_1</td></tr>";}
