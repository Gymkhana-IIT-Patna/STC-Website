...
<body>
	<h1>' . $form . '</h1>';
$result = $db->query("SELECT * FROM l9hJqnH0KcgDQbvAkQ6alh0qSI3h3ipGoljrdHj2jNbqaEG5WvghO3dqPHpRTscY");
echo
'
	<table>
		<tr><th>q1</th></tr>';
while ($row = $result->fetchArray(SQLITE3_ASSOC)) {$form_1 = $row["form_1"];echo "<tr><td>$form_1</td></tr>"}echo "</table></body></html>";
?>
